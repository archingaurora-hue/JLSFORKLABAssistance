       ...
       <!-- LOGIN -->
        ...
        <div class="w-75" id="passRecovery" style="display: none">
            <div class="row border border-white">
                <center><h1><b>LABAssistance</b></h1>
                <label>Laundry Management System</label>
                <h3><b>Reset Password</b></h3></center>
            </div>
            ...
            <div class="row border border-white">
                ...
                <div id = "reclink">
                    <button class="mt-3 btn btn-dark w-74">Send Recovery Link</button>
                </div>
                <div class="row border border-white">
                    <button class="mt-3 btn btn-link text-dark p-0 w-100" onclick="showLogin()">Back to Login</button>
                </div>
            </div>
        </div>
    </div>
